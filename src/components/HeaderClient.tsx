        ...
        <header className="w-[95%] lg:w-[98%] bg-brand rounded-[2rem] lg:rounded-full px-4 lg:px-6 md:mt-4 mb-6 mx-auto lg:mx-4 relative z-50">
            <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between py-4 lg:py-0 gap-4 lg:gap-0">
                <div className="w-full lg:w-auto flex items-center justify-between">
                    {/* Logo Section */}
                    <Link to="/mon-espace" className="flex items-center gap-3 lg:gap-4 group" aria-label="Mon espace - Handepassement">
                        <img
                            src={logo}
                ...
                >
                    ...
                    <button onClick={handleLogout} className="px-8 py-3 lg:px-6 lg:py-3 xl:px-10 xl:py-4 bg-accent text-brand text-lg lg:text-base xl:text-xl font-bold rounded-full hover:bg-accent-400 transition-colors shadow-sm w-full lg:w-auto text-center">
                        Déconnexion
                    </button>
                </nav>
            </div>
